...
import com.bdmitech.android.huawei.qpay.utils.SetUserId;
...
//                    if (CheckMasterKeyAndSessionId.checkMasterKeyAndSessionId() == true) {
                            mStrSetUserIdResponse = SetUserId.setUserId(mStrEncryptUserId, mStrEncryptAccountNumber, GlobalData.getStrMasterKey());
