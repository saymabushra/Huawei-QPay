...
import com.bdmitech.android.huawei.qpay.utils.CheckToken;
import com.bdmitech.android.huawei.qpay.utils.Decryption;
import com.bdmitech.android.huawei.qpay.utils.Encryption;
import com.bdmitech.android.huawei.qpay.utils.GetMasterKeyAndAccountNumberByDeviceId;
...
//                mBtnSubmit.setEnabled(false);
                ...
                //########################## Get MasterKey & Encrypt Account Number ############################
                //########################## Get MasterKey & Encrypt Account Number ############################
                String strMasterKeyAndAccountNumberByDeviceId = GetMasterKeyAndAccountNumberByDeviceId.getMasterKeyAndAccountNumberByDeviceId(mStrDeviceId, GlobalData.getStrRegistrationSecurityKey());//99792525063258043845161478830524*2WWtXiRqc+0yI10y28UqUA==
                ...
                if (intIndexToken == -1) {
                    ...
                    try {
                        ...
                        mStrEncryptToken = encryption.Encrypt(mEditTextToken.getText().toString(), mStrMasterKey);
...
//                    if (CheckMasterKeyAndSessionId.checkMasterKeyAndSessionId() == true) {
                                ...
                                //########################## Check TokenSubmission ############################
                                //########################## Check TokenSubmission ############################
                                String strCheckTokenResponse = CheckToken.checkToken(mStrEncryptAccountNumber, mStrEncryptToken, mStrMasterKey);
