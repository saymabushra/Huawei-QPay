...
public class GetThana {
	public static String getThana(String strEncryptAccountNumber,String strEncryptPin,String strDistricId,String strMasterKey) {
...
//		strMasterKey
		...
		encryptDistrictId.setName("DistrictID");
