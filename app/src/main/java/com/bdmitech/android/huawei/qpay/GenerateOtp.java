...
public class GenerateOtp extends AppCompatActivity implements View.OnClickListener {
        ...
        if (v == mBtnGenerateOtp) {
            if (mEditTextNumberOfTransaction.getText().toString().length() == 0) {
                ...
                try {
                    ...
                    mStrEncryptNumberOfTransaction = encryption.Encrypt(mEditTextNumberOfTransaction.getText().toString(), mStrMasterKey);
                    ...
                    mStrEncryptOtpDuration = encryption.Encrypt(mStrOtpDuration, mStrMasterKey);
            ...
            if (mEditTextNumberOfTransaction.getText().toString().length() == 0) {
                ...
                myAlert.setNegativeButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                dialog.cancel();
                                startActivity(new Intent(GenerateOtp.this, QPayMenuNew.class));
                                finish();
                            }
                        });
                AlertDialog alertDialog = myAlert.create();
    ...
    public void generateOtp(String strEncryptAccountNumber,
        ...
        encryptMaxNumberOfTransaction.setName("MaximiumTransactionNo");
        ...
        encryptDurationInMin.setName("TransactionDurationInMiniute");
...
//                //#############################################
                ...
                while (cur.moveToNext()) {
                    if (cur.getString(2).equalsIgnoreCase("BDMITECH")) {
