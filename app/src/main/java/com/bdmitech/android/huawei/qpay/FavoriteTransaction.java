...
import com.bdmitech.android.huawei.qpay.utils.CustomList;
import com.bdmitech.android.huawei.qpay.utils.DeleteFavoriteList;
import com.bdmitech.android.huawei.qpay.utils.EncryptionDecryption;
import com.bdmitech.android.huawei.qpay.utils.GetAllFavoriteList;
...
public class FavoriteTransaction extends AppCompatActivity implements View.OnClickListener {
    ...
    private String mStrCaption, mStrSourceWallet, mStrDestinationWallet,
            mStrDestinationWalletHolderName, mStrAmount, mStrFunctionType;
    ...
    public void onClick(View v) {
        if (v == mBtnDeleteAll) {
            ...
            try {
                String encryptCaption = encryptionDecryption.Encrypt("allfavfun", GlobalData.getStrMasterKey());
                String deleteFavoriteItemResponse = DeleteFavoriteList.deleteFavoriteList(GlobalData.getStrEncryptAccountNumber(), encryptCaption, GlobalData.getStrMasterKey());
    ...
    private void loadAllFavoriteList() {
        ...
        String strAllFavoriteList = GetAllFavoriteList.getAllFavoriteList(GlobalData.getStrEncryptAccountNumber(), GlobalData.getStrMasterKey());
                        ...
                        a.setPositiveButton(
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        dialog.cancel();
                                        try {
                                            if (mStrFunctionType.equalsIgnoreCase("CFT")) {
                                            ...
                                            } else if (mStrFunctionType.equalsIgnoreCase("CMP")) {
                                                GlobalData.setStrFavCaption(mStrCaption);
                                                GlobalData.setStrFavSourceWallet(mStrSourceWallet);
                                                GlobalData.setStrFavDestinationWallet(mStrDestinationWallet);
                                                GlobalData.setStrFavDestinationWalletAccountHolderName(mStrDestinationWalletHolderName);
                                            ...
                                            } else if (mStrFunctionType.equalsIgnoreCase("MFM")) {
                                                GlobalData.setStrFavCaption(mStrCaption);
                                                GlobalData.setStrFavSourceWallet(mStrSourceWallet);
                                                GlobalData.setStrFavDestinationWallet(mStrDestinationWallet);
                                                GlobalData.setStrFavDestinationWalletAccountHolderName(mStrDestinationWalletHolderName);
...
//                                    String encryptCaption = encryptionDecryption.Encrypt(mStrCaption, GlobalData.getStrMasterKey());
//                                    String deleteFavoriteItemResponse = DeleteFavoriteList.deleteFavoriteList(GlobalData.getStrEncryptAccountNumber(), encryptCaption, GlobalData.getStrMasterKey());
//                                    //####################### Show Dialog ####################
//                                    //####################### Show Dialog ####################
//                                    //####################### Show Dialog ####################
...
//                                    myAlert.setMessage(deleteFavoriteItemResponse);
//                                    myAlert.setNegativeButton(
//                                            "OK",
//                                            new DialogInterface.OnClickListener() {
//                                                public void onClick(DialogInterface dialog, int id) {
...
//                            //                        ImageButton imgBtnGo = view.findViewById(R.id.imgBtnGo);
...
//                        });
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(FavoriteTransaction.this, QPayMenuNew.class));
            return false;
        }
