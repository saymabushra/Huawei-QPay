...
import com.bdmitech.android.huawei.qpay.utils.DoChangePin;
...
//                disableUiComponentAfterClick();
                try {
                    ...
                    mStrEncryptNewPin = encryption.Encrypt(mEditTextNewPin.getText().toString(), mStrMasterKey);
                    ...
                    Thread t = new Thread(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            String strChangePinResponse = DoChangePin.doChangePin(
...
//        mEditTextNewPin.setBackgroundColor(Color.DKGRAY);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(ChangePin.this, QPayMenuNew.class));
            return false;
        }
